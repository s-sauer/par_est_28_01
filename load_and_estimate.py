...
p0.add('mumaxE', value=0.17, min=0.12, max=0.19, vary=False)
p0.add('base_coef', value=1, min=0.0001, vary = True) 

p0.add('cSCrab', value=0.1, min=0.008, max=0.15, vary = False)
  
p0.add('Ks', value=0.1, min=0.01, max=1,  vary=False)
p0.add('Ke', value=0.1, min=0.01, max=1, vary=False)
p0.add('Ki', value=0.1, min=0.01, max=1, vary=False)

p0.add('YxsOx', value=0.49, min=0.4, max=0.55, vary=False)
p0.add('YxsRed', value=0.05, min=0.1, max=1, vary=False)
p0.add('Yxe', value=0.72, min=0.5, max=0.8, vary=False)


#Biomasscomposition paramaters, content H,O,N

p0.add('HX', value=1.79, min=1.77, max=2.1, vary=False)
p0.add('OX', value=0.57, min=0.54, max=0.63, vary=False)     #von paper sonnleiter, wurde auch OX content variiert
p0.add('NX', value=0.15, min=0.14, max=0.16, vary=False)
